...
#     (0, 1, 10, "QuadEaseInOut"),
    (75, 1, 10, "QuadEaseInOut"),
]

# gradient_sequence2 = [
#     (0, 0.01, 1, "LinearInOut"),
#     (25, 1, 10, "QuadEaseInOut"),
#     (0, 1, 10, "QuadEaseInOut"),
#     (10, 1, 10, "QuadEaseInOut"),
# ]
...
secrets = {"ssid": "forest", "password": "supersecret"}
wifi = wifimanager.ESPSPI_WiFiManager(esp, secrets) #,status_light
wifi.create_ap()
...
#     print((x,y, z))
    ...
    if isPeak == False:
        ...
        if timer.expired():
            ...
            pixels.fill((position_output1, 255, position_output1))
            pixels.show()
# Write your code here :-)
